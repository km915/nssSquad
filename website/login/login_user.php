...
<div class="container">
    <div class="form-box">
        <h1 id="title">Sign Up as user</h1>
...
signupBtn.onclick = function() {
    ...
    title.innerHTML = "Sign Up as User";
...
signinBtn.onclick = function() {
    ...
    title.innerHTML = "Sign In as User";
    ...
    if (empty($username)) {
        ...
        if ($_POST['action'] == 'signup') {
            ...
            if (mysqli_num_rows($result_check) > 0) {
                ...
                $sql = "INSERT INTO users (name, username, password, user_type) VALUES ('$name', '$username', '$hash', 'user')";
            ...
            $sql = "SELECT * FROM users WHERE username = '$username' AND user_type='user'";
            ...
            if (!$user) {
                ...
                echo "<script>setTimeout(function() { window.location.href = 'homepages/homepage_user.php'; }, 1000);</script>"; 
                exit();
            }
        }
    }
