...
<div class="container">
    <div class="form-box">
        <h1 id="title">Sign Up as Admin</h1>
...
signupBtn.onclick = function() {
    ...
    title.innerHTML = "Sign Up as Admin";
...
signinBtn.onclick = function() {
    ...
    title.innerHTML = "Sign In as Admin";
    ...
    if (empty($username)) {
        ...
        if ($_POST['action'] == 'signup') {
            ...
            if (mysqli_num_rows($result_check) > 0) {
                ...
                $sql = "INSERT INTO users (name, username, password, user_type) VALUES ('$name', '$username', '$hash', 'admin')";
            ...
            if (!$user) {
                ...
                echo "<script>setTimeout(function() { window.location.href = 'homepages/homepage_admin.php'; }, 1000);</script>"; // Redirect after 1 second
                exit();
            }
        }
    }
